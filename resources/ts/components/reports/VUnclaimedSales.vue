    ...
    <div>
        ...
        >
                    ...
                    <div class="col-12 col-xl-3 pl-xl-0">
                        <div class="form-group">
                            ...
                            <div class="d-flex flex-no-wrap">
                                <validation-provider name="対象請求日" rules="required" immediate v-slot="{ errors }">
            ...
            <template v-slot:th>
                ...
                <sr-th v-model="conditions.sort" colName="period"                 >対象請求日</sr-th>
                <sr-th v-model="conditions.sort" colName="slip_cnt"               >売上伝票数</sr-th>
                <sr-th v-model="conditions.sort" colName="accounting_date"        >最終売上日</sr-th>
                <sr-th v-model="conditions.sort" colName="total_price"            >売上額</sr-th>
                <sr-th v-model="conditions.sort" colName="payment_day"            >最終入金日</sr-th>
                <sr-th v-model="conditions.sort" colName="payment_price"          >入金額</sr-th>
                <sr-th v-model="conditions.sort" colName="complete_day"           >最終請求日</sr-th>
                <sr-th v-model="conditions.sort" colName="grand_total"            >請求額</sr-th>
