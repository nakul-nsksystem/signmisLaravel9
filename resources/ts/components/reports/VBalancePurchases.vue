    ...
    <div>
        <sr-container
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xl-1 pl-xl-0">
                        <div class="form-group">
                            <label>勘定科目</label>
                            <m-kv-select
                                v-model="conditions.accounts_title"
            ...
            <template v-slot:th>
                ...
                <sr-th v-model="conditions.sort" colName="payment_price">支払合計</sr-th>
...
const { cDateFormat, cToNumber, cSummary, cTermAlert, getCalcedMonth, cGetClosingDate } = signmisReportComposition() ;
