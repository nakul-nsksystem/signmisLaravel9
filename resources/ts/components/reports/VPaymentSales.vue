    ...
    <div>
        <sr-container
            ...
            <template v-slot:header>
                <div class="row">
                    ...
                    <div class="col-12 col-xl-1 pl-xl-0">
                        <div class="form-group">
                            <validation-provider name="入金予定" rules="between:0,99" immediate v-slot="{ errors }" >
                                <label>入金予定</label>
                                <ns-number-input
            ...
            <template v-slot:th>
                ...
                <sr-th v-model="conditions.sort" colName="m_customer_payment_date">取引先支払日</sr-th>
                <sr-th v-model="conditions.sort" colName="payment_price">入金額</sr-th>
                <sr-th v-model="conditions.sort" colName="payment_total">入金合計</sr-th>
                <sr-th v-model="conditions.sort" colName="payment_name">入金区分名</sr-th>
                <sr-th v-model="conditions.sort" colName="complete_day">対象請求日</sr-th>
                <sr-th v-model="conditions.sort" colName="due_date">入金予定日</sr-th>
                <sr-th v-model="conditions.sort" colName="sub_total">売上合計</sr-th>
                <sr-th v-model="conditions.sort" colName="payment_memo">入金備考</sr-th>
