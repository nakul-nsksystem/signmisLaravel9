    ...
    <div>
        <sr-container
            ...
            <template v-slot:th>
                ...
                <sr-th colName="product_name"     >材料名</sr-th>
                <sr-th colName="project_cd"       >物件CD</sr-th>
                <sr-th colName="qty"              >数量</sr-th>
                <sr-th colName="unit_m_kv_name"   >単位</sr-th>
                <sr-th colName="total_price"      >仕入額</sr-th>
                <sr-th colName="tax_rate"         >税率</sr-th>
                <sr-th colName="tax"              >消費税</sr-th>
                <sr-th colName="payment_price"    >支払額</sr-th>
