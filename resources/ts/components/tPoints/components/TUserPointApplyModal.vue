<template>
  <div
    id="modelTUserPointApply"
    class="modal fade"
    tabindex="-1"
    role="dialog"
    aria-labelledby="modelTUserPointApply"
    aria-hidden="true"
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <div class="d-flex flex-no-wrap">
                  ...
                  >
                    <option value=""></option>
                    <option value="6000003">使用申請</option>
                  </select>
                </div>
              </div>
            </div>
...
function closeModal() {
  $("#modelTUserPointApply").modal("hide");
}
</script>
<script lang="ts">
export default {
