                                ...
                                <table class="table table-striped table-dark table-hover list">
                                    ...
                                    <tbody>
                                        <tr v-for="n in dRows" :key="n.detail_id">
                                            ...
                                            <td class="text-nowrap d-none d-lg-table-cell">{{ n.project_cd }}</td>
...
export default {
    ...
    data : function () {
        return {
            ...
            dSearch : {                             // 画面上の検索項目
                ...
                closing_date : 0,                   // 締日(買掛は拠点の締日[20]がデフォルト)
                id_min : "" ,                       // 仕入Id(Min)
                id_max : "" ,                       // 仕入Id(Max)
    ...
    methods : {
        ...
        runExport : async function () {
            if (!confirm('仕入データを出力してもよろしいですか?')) return ;
            ...
            try {
                ...
                link.setAttribute('download', `export_purchases_${now}.csv`) ;
                link.click();
