<div class="box-detail" id="detailCard">
	...
	<div class="box-detail-card">
		<div class="item-underline">
			<div class="box-detail-row">
				<div class="box-col-12">
					...
					<span class="productQty">×<span class="emphasis">{{$item->qty}}</span></span>
				</div>
			</div>
			<div class="box-detail-row">
				<div class="box-col-12">
					@foreach($item->TProjectDeliveries as $delivery)
					<div class="item item1" style="text-align:right; padding:5px">
		...
		<div class="box-detail-row">
			<div class="box-col-3 box-col-3-2">
		...
		<div class="proccess_info">
			@foreach($item->TProjectProductProcesses as $process)
				@if($process->is_enabled)
					<div class="box-detail-row">
						<div class="box-col-3">{{$process->MProcessCategory->name}}</div>
		...
		@php
			...
			/**分割図の縮小（横300,縦300までに指定） */
			$sepW = $item->size_w ;
			$sepH = $item->size_h ;

		@endphp
		<div class="box-detail-row sepOrBLDiv">
			@if(count($item->TProjectProductBoardlayouts))	
				<div class="box-col-6-1">
					<div>板割</div>
				</div>
				<div class="box-detail-row">
					<table class="board">
			...
			@if($isSep )
				<div class="box-detail-row sepOrBLDiv">
					<div class="box-col-6">
						<div class="box-col-6-1">
							<div>分割　重ね代:{{$item->sep_overlap_length}}</div>
						</div>
						<div class="box-detail-row">
							<div class="box-col-6">
