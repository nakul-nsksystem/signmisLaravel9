...
CREATE 
PROCEDURE pr_t_complete_process(
...
BEGIN
    ...
    -- 締確認
    CALL pr_t_complete_validation(pResult, pMessage, pMUserId, pMBranchId, pDealingMkvId, pCompleteDay, pClosingDate, pCustomerId, TRUE, FALSE) ;
    ...
    SET pMessage = CONCAT('締処理が完了しました[', IF(pDealingMkvId = 1010001, '売', '買'), '][締対象日：', pCompleteDay, '][件数：', cnt, ']') ;
