...
CREATE 
PROCEDURE pr_t_complete_cancel(
...
BEGIN
    ...
    -- 締確認
    CALL pr_t_complete_validation(pResult, pMessage, pMUserId, pMBranchId, pDealingMkvId, pCompleteDay, pClosingDate, pCustomerId, FALSE, FALSE) ;
