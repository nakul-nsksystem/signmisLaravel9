...
SELECT m_branch_id             AS m_branch_id             , /* 拠点id     */
       ...
       m_customer_id           AS m_customer_id           , /* 取引先id   */
       m_customer_cd           AS m_customer_cd           , /* 取引先cd   */
       m_customer_name         AS m_customer_name         , /* 取引先名   */
       m_customer_closing_date AS m_customer_closing_date , /* 取引先締日 */
       m_user_name             AS m_user_name             , /* 担当者名   */
       period                  AS period                  , /* 対象請求日 */
       slip_cnt                AS slip_cnt                , /* 売上伝票数 */
       accounting_date         AS accounting_date         , /* 最終売上日 */
       total_price             AS total_price             , /* 売上額     */
       payment_day             AS payment_day             , /* 最終入金日 */
       payment_price           AS payment_price           , /* 入金額     */
       complete_day            AS complete_day            , /* 最終請求日 */
       grand_total             AS grand_total             , /* 請求額     */
