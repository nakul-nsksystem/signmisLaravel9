...
class ExportPaymentPurchaseApiController extends BaseApiController
{

    use CsvExportTrait ;
    use ExportPaymentTrait;

    protected $dealingMKvId = 1010002 ;
    ...
    private function getQuery(Request $req)
    {
        ...
        return 
            $this->getFiltered($req)
                ...
                ->join('m_kvs AS kv1', 'm_customers.accounts_title_m_kv_id', '=', 'kv1.id')
    ...
    public function export(Request $req)
    {
        ...
        foreach($this->getQuery($req) as $row) {
            ...
            //借方科目コード cd1 手数料の時は固定
            if( $row->payment_m_kv_id == 1150008) $cd1 = 751 ;
